...
\bulletlist{Operating systems}{
    \bitem {Desktop/server Linuxes} {1}{Greatly prefer Debian. Used Linux for a decade or more}
...
\bulletlist{Tools, Frameworks \& Tech} {
    ...
    \bitem {Jenkins}        {3}{Used and configured professionally for contiuous integration }
