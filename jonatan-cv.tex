...
\bulletlist{Tools \& Frameworks} {
    \bitem {Yocto} {Advanced knowledge, writted reciped, made \& maintained layers}
    \bitem {Qt Core}{Semi-advanced knowledge, used for medium sized projects}
    \bitem {Glib} {Semi-advanced knowledge, used for medium sized projects}
    \bitem {Glibmm} {Semi-advanced knowledge, used for medium sized projects}
    \bitem {GNU Make} {Semi-advanced knowledge, developed several reasonably complex build scaffoldings}
    \bitem {CMake} {Semi-advanced knowledge, build system of choice, developed several reasonably complex build scaffoldings}
    \bitem {Android Binder} {Developed several reasonably complex native services and sandboxed apps which have used the Binder IPC}
    \bitem {U-Boot} {General knowledge as a user, used on ARM targets}
    \bitem {Tizen-IVI} {General knowledge, developed some software for the platform}
    \bitem {Android build system} {General knowledge, developed several Android native and sandboxed apps/services in AOSP}
    \bitem {Git Build System (GBS)} {General knowledge, built Tizen-IVI and software for it using GBS}
}
