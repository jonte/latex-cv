...
\bulletlist{Tools, Frameworks \& Tech} {
    ...
    \bitem {Linux kernel}   {2}{Written several GPIO, I$^2$C and SPI device drivers. Configured device trees, optimized kernels for boot and execution speed. I have ported several large proprietary drivers from old to new kernel versions.}
