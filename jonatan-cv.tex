...
\bulletlist{Operating systems}{
    ...
    \bitem {WindRiver Linux}        {1}{I have provided expert support for WRL5/8/18/22 on a contractor basis}
    \bitem {Yocto project}          {1}{I have provided expert support for Yocto-based Linuxes}
    \bitem {Microsoft Windows}      {2}{Used at home from time to time}
}
\bulletlist{Development environments \& IDEs}{
    ...
    \bitem {KiCad 5/6/7}    {1} {Used for small and medium sized electronics projects, including RP2040, STM32 and ESP32. This is my PCB/schematics CAD tool of chioce.}
...
\bulletlist{Tools, Frameworks \& Tech} {
    ...
    \bitem {Linux kernel}   {2}{Written several GPIO, I$^2$C, SPI, and (bitbanged) JTAG device drivers. Configured device trees, optimized kernels for boot and execution speed. I have ported several large proprietary drivers from old to new kernel versions.}
    \bitem {U-Boot}         {2}{Used on ARM targets. Used for A/B partitioning schemes, network configuration, etc.}
    ...
    \bitem {Meson}          {3}{I have used Meson for several personal projects}
...
\bulletlist{Chips \& hardware} {
    ...
    \bitem {SPI}         {4}{I have developed device drivers for SPI devices, mainly for radio tuner hardware}
    \bitem {I$^2$C}      {4}{I have developed device drivers for SPI devices, mainly for radio tuner hardware}
...
\bulletlist{Electronics manufacturing} {
