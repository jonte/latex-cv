...
\section*{Personal data}
  \cvtable{
    ...
    Address        & Göteborg/Sävedalen, Sweden   \\
...
\\\\
I have implemented software ranging from data collection scripts in e.g. Python, application software in C and C++, Linux device drivers in C to bluetooth applications in Zephyr. The hardware used has ranged from multiple racks of powerful x86 down to battery-powered ARM devices depending on project and application.
\\\\
...
\bulletlist{Programming languages}{
    ...
    \bitem {MicroPython}{2}{Used for prototyping on microcontrollers}
...
\bulletlist{Operating systems}{
    \bitem {Desktop/server Linuxes} {1}{Greatly prefer Debian. Used Linux for more than two decades}
    \bitem {WindRiver Linux}        {1}{I have provided expert support for WRL5-24 on a contractor basis}
    \bitem {Yocto project}          {1}{I have provided expert support for Yocto-based Linuxes}
    \bitem {Zephyr}                 {2}{Used for small-scale projects}
}
\bulletlist{Development environments \& IDEs}{
    \bitem {Vim}            {1} {Environment of choice.}
    \bitem {Fusion360}      {1} {Used for additive manufacturing, PCB design, sheet metal, and 3D model work (for e.g. KiCad models). This is my CAD/CAM system of choice.}
    \bitem {KiCad 5-9}      {1} {Used for many electronics projects, including RP2040, STM32, ESP32, T113-S3 and i.MX91. This is my eCAD tool of choice.}
    \bitem {Eclipse}        {3} {Used for Java development}
    \bitem {Android Studio} {3} {Used for Java Android apps}
    \bitem {Cadence OrCAD}  {4} {Used for working with NXP reference designs}
}
...
\bulletlist{Tools, Frameworks \& Tech} {
    ...
    \bitem {Gerrit}         {1}{I have worked with Gerrit in several projects}
    \bitem {Linux kernel}   {1}{Written several crypto, GPIO, I$^2$C, SPI, and (bitbanged) JTAG device drivers. Configured device trees, brought up new hardware, optimized kernels for boot and execution speed. I have ported several large proprietary drivers from old to new kernel versions.}
    \bitem {U-Boot}         {1}{Used on ARM targets. Used board bringups, NXP HABv4, A/B partitioning schemes, network configuration, etc.}
    \bitem {Secure boot}    {2}{I have implemented secure boot on NXP platforms using HAB, U-Boot, dm-verity, dm-crypt, Linux, and CAAM red/black keys}
    \bitem {SWUpdate}       {2}{Use for OTA updates with custom update procedures for e.g. bootloaders, applications and partitioning}
    \bitem {OpenSSL}        {3}{I have implemented OpenSSL providers for custom hardware-accelerated crypto}
    \bitem {Linux PAM}      {3}{I have implemented custom Pluggable-authentication-modules for custom authentication mechanisms for e.g. OpenSSH}
    \bitem {Jenkins}        {3}{Used and configured professionally for continuous integration}
    ...
    \bitem {CMake}          {3}{I have developed several reasonably complex build scaffoldings}
    \bitem {Meson}          {3}{Build system of choice. I have used Meson for several projects}
    \bitem {Process containment}    {3} {I have extensive Docker competence, and have some Kubernetes experience}
...
\bulletlist{Chips \& hardware} {
    \bitem {Allwinner T113-S3}   {2}{Used for custom low-cost designs}
    \bitem {NXP i.MX6}   {2}{I have extensive experience with i.MX6 for e.g. secure boot and CAAM crypto}
    \bitem {NXP i.MX91}  {2}{Used for custom PCB designs}
    \bitem {Skyworks Si3404}  {3}{Used to develop PoE class 2 devices}
    \bitem {Microchip IGLOO FPGA}  {3}{I have developed in-the-field programming software using Microchip DirectC}
    ...
    \bitem {SPI}         {4}{I have experience with SPI devices and controllers on NXP and Allwinner platforms}
    \bitem {I$^2$C}      {4}{I have experience with I2C devices and controllers on NXP and Allwinner platforms}
    \bitem {CAN}         {4}{I have developed userspace code for interacting with CAN devices in automotive networks}
    \bitem {ESP32 S3}    {4}{I have developed sensor prototypes based on ESP32 S3, HTTP and deep sleep}
    \bitem {RP2040}      {4}{I have developed PID regulators using RP2040 and SSRs for driving heating elements}
}

\bulletlist{Electronics prototyping} {
    \bitem {Reflow soldering} {3}{I have basic knowledge of reflow soldering, and have developed my own reflow soldering oven for small prototypes}
    \bitem {Hot air rework}   {3}{I have basic knowledge of hot air rework from reworking prototype boards}
    \bitem {SMT/THT soldering}{3}{I have basic knowledge of manually populating and soldering SMT and THT components for prototype boards}
    \bitem {PCBA services}{3}{I have experience in designing for Aisler, JLCPCB and PCBWAY for quick prototyping}
}
